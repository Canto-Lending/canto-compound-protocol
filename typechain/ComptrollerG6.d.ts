...
interface ComptrollerG6Interface extends ethers.utils.Interface {
  functions: {
    ...
    "getCantoAddress()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getCantoAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ComptrollerG6 extends BaseContract {
  ...
  functions: {
    ...
    getCantoAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getCantoAddress(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getCantoAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
