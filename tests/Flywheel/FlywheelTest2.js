const {
  ...
  describe('Flywheel', () => {
    ...
    beforeEach(async () => {
      ...
      console.log("after makeComptroller");
      expect(comptroller).toBeDefined();
    ...
    it('should be able to claim rewards for supplier', async () => {
      const mkt = cREP;
      const tx = await send(comptroller.comp, 'transfer', [a1, etherUnsigned(50e18)], {from: comptroller._address});
